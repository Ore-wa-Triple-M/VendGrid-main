...
function setupSmoothScrolling() {
    document.querySelectorAll('a[href^="#"]').forEach(link => {
        link.addEventListener('click', function (e) {
            ...
            // Guard: bare "#" or empty selector would throw a SyntaxError
...
// ── Toast notifications (message is text-safe) ────────────────────────────────
function showNotification(message, type = 'info') {
    ...
    body.textContent = message;   // textContent — never innerHTML — prevents XSS
